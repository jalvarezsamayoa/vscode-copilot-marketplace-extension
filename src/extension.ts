...
export function activate(context: vscode.ExtensionContext) {
	...
	const listMarketplace = vscode.commands.registerCommand('vscode-copilot-marketplace.listMarketplace', () => {
		// The code you place here will be executed every time your command is executed
		// Display a message box to the user
		vscode.window.showInformationMessage('List of installed extensions in the marketplace.');
	});
