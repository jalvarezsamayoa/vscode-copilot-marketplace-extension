...
suite('Update Marketplace - Valid Git Repo', () => {
    test('should pull if git repo with remote exists', async () => {
...
suite('Update Marketplace - Not A Git Repo', () => {
    test('should throw NOT_A_GIT_REPO if not a git repo', async () => {
        const mockHomeDir = () => '/mock/home';
...
suite('Update Marketplace - No Remotes', () => {
    test('should throw NOT_A_GIT_REPO if no remotes', async () => {
        const mockHomeDir = () => '/mock/home';
...
suite('Update Marketplace - Git Errors', () => {
    test('should throw error if git pull fails', async () => {
        const mockHomeDir = () => '/mock/home';
