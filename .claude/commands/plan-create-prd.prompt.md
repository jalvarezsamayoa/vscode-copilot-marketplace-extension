...
description: Generates a Product Requirements Document (PRD) in Markdown format based on an initial user prompt.
---
...
4. **Save PRD:** Save the generated document as `prd.md` inside the `tasks/[feature-name]/` directory.
